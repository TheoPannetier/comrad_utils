...
Rscript -e "source(\"/data/$USER/fabrika/R/run_dd_ml_hpc_without_fossil.R\"); run_dd_ml_hpc_without_fossil(siga = ${SIGA}, sigk = ${SIGK}, dd_model = comrad::dd_model_${DDMODEL}(), i = ${TREE}, job_id = ${SLURM_JOB_ID}, verbose = ${VERBOSE})"
